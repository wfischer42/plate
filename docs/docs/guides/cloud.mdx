...
Plate Cloud is the official Plate plugin and cloud service for image and attachment uploads, automatic server-side image resizing, and future Plate cloud services. It includes 1 GB of free uploads.
...
[Get more info about Plate Cloud.](https://portive.com/)
...
To use Plate Cloud first [get a free API key from Portive which includes 1 GB of free uploads](https://portive.com/).
